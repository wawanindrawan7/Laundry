...
public class PelangganForm extends javax.swing.JInternalFrame {
    ...
    public void create() {
       Pelanggan pelanggan = new Pelanggan();
        ...
        pelanggan.setNoTelp(tfNoTelp.getText());
        pelanggan.setAlamat(taAlamat.getText());

        dao.create(pelanggan);
    }
    ...
    public void getRecord() {
        ...
        if (selected > 0) {
            ...
            if (conf == JOptionPane.YES_OPTION) {
                ...
                tfNama.setText(tbUser.getValueAt(baris, 1).toString());
                tfNoTelp.setText(tbUser.getValueAt(baris, 2).toString());
                taAlamat.setText(tbUser.getValueAt(baris, 3).toString());
            }
        } else {
